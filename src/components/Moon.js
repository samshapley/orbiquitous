...
class MoonVisualization {
    constructor(containerId) {
        ...
        this.vizContainer = document.getElementById('moonViz');
        if (!this.vizContainer) {
            this.vizContainer = document.createElement('div');
            this.vizContainer.id = 'moonViz';
        ...
        // Initialize moon globe
        this.moon = new ThreeGlobe()
        ...
        // Adjust globe size
        this.moon.scale.set(1.2, 1.2, 1.2);
    ...
    animate() {
        ...
        if (this.moonContainer) {
            ...
            this.moonContainer.rotation.y += rotationSpeed;
        }
